        ...
        <div id="header">
            ...
            <div id="menubar">
                <ul id="menu">
                    ...
                    <sec:authorize access="!hasRole('ROLE_ADMIN') and isAuthenticated()">
                        <li class="selected"><a href="/profile/${user.username}">Profile</a></li>
                    </sec:authorize>
                        ...
                        <form action="/profile/${user.username}/update_student" method="POST">
                            <ul class="ver-table">
                                ...
                                <li>
                                    ...
                                    <span><input class="read" type="text" name="studentID" value="${student.studentID}"
                                            readonly /></span>
                                </li>
                                <li>
                                    <label>Name:</label>
                                ...
                                <li>
                                    <label>Contact:</label>
                                    <span><input type="number" name="contactNo" placeholder="Contact"
                                            value="${student.contactNo}"></span>
                                </li>
                                <li>
                                    <label>Address:</label>
                                    <span>
                                ...
                                <li>
                                    ...
                                    <span><input type="number" name="gcontactNo" placeholder="Guardian Contact"
                                            value="${guardian.gcontactNo}"></span>
                                </li>
                            </ul>
                            <div class="container">
                        ...
                        <form action="/profile/${user.username}/update_teacher" method="POST">
                            <ul class="ver-table">
                                ...
                                <li>
                                    ...
                                    <span><input class="read" type="text" name="TeacherID" value="${teacher.teacherID}"
                                            readonly /></span>
                                </li>
                                <li>
                                    <label>Name:</label>
