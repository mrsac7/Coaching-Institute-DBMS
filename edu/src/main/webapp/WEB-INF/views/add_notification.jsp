            ...
            <div class="content">
                ...
                <form action="/notification/add" method="POST">
                    <ul class="ver-table">
                        <li>
                            <label>Header:</label>
                            <span><input type="text" name="header" placeholder="Header"/></span>
                        </li>
                        <li>
                            <label>Body:</label>
                            <span><textarea name="body" rows="10" placeholder="Body" cols="60"></textarea></span>
                            <!-- <span><input type="text" name="body" placeholder="Body" /></span> -->
                        </li>
                    </ul>
                    <div class="container">
